...
export const postData = [
  { category: '후기', title: '블랙핑크 콘서트 후기', viewCount: '8', username: 'test', createdAt: 1698852838700 },
  {
    category: '동행 구해요',
    title: '도라에몽 팝업 같이 가실 분',
    viewCount: 21,
    username: 'test2',
    createdAt: 1698852899900,
  },
  {
    category: '자유롭게 소통해요',
